...
import 'package:pr5/pages/info_page.dart';
import '../data.dart';
import '../components/drink_item.dart';
import '../models/drink.dart';

class FavoritesPage extends StatelessWidget {
  const FavoritesPage({super.key, required this.drinks, required this.addNewDrink, required this.toggleFavorite});
  ...
  void _navigateToInfoPage(BuildContext context, int index) async {
    Navigator.push(
        ...
        MaterialPageRoute(
            builder: (context) =>
                InfoPage(drink: drinks[index], isDeletable: false,)
        ));
  }
